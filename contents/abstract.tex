...
\keyword{非线性控制; 模型参考自适应控制； 伺服控制；改良PD控制算法; \par
多体动力学仿真}
...
\enkeyword{Nonlinear control, Model-reference adaptive control, Servo control, \par
Improved PD control algorithm, Simscape Multibody}
